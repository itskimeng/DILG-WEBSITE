 ...
 */
class EasyImageRotatorCpViewHelp extends JViewLegacy
{
	...
	*/
	protected function addToolBar() 
	{
		...
		JSubMenuHelper::addEntry(JText::_('COM_EASYIMAGEROTATOR_MENU_DASHBOARD'), 'index.php?option=com_easyimagerotator', false);
		JSubMenuHelper::addEntry(JText::_('COM_EASYIMAGEROTATOR_MENU_HELP'), 'index.php?option=com_easyimagerotator&task=help', true);
	}
}
?>