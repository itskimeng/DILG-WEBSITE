...
class YoutubeGalleryTheme_SimpleGridJCEPopupInstallerScript
{
	function preflight($route, $adapter)
	{
		YoutubeGalleryTheme_SimpleGridJCEPopupInstallerScript::deleteIfExists();
	}
	...
	function deleteIfExists()
	{
		...
		$db = JFactory::getDbo();
		$db->setQuery('DELETE FROM #__extensions WHERE name = "YoutubeGalleryTheme_SimpleGridJCEPopup" ');
		if (!$db->query())    die( $db->stderr());
	}

        function install($parent)
        {
		$theme_name='SimpleGridJCEPopup';
