...
class YoutubeGalleryTheme_DefaultInstallerScript
{
	function preflight($route, $adapter)
	{
		YoutubeGalleryTheme_DefaultInstallerScript::deleteIfExists();
	}
	...
	function deleteIfExists()
	{
		...
		$db = JFactory::getDbo();
		$db->setQuery('DELETE FROM #__extensions WHERE name = "YoutubeGalleryTheme_Default" ');
