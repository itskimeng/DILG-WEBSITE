 ...
 * @since  3.2
 */
class JFormFieldnxRange extends JFormFieldNumber
{
	/**
	 * The form field type.
	 *
	...
	protected function getInput()
	{
		...
		return '<input id="slider" type="range" name="' . $this->name . '" id="' . $this->id . '"' . ' value="'
			...
			. $onchange . $max . $step . $min . $autofocus . ' onchange="updateTextInput(this.value);" /><span class="alert" id="actualVolume"></span>';
	}
}
