...
*/
    ...
    class mod_Videogallerydisbeautifuljhm
    {    
        ...
        */
        public function generate()
        {
            ...
            {
                $className = 'jhm'.ucfirst($class['source']).'Helper';
        ...
        * @param string $style
        * @return mod_Videogallerydisbeautifuljhm
        */
        ...
        private function onDataError($params)
        {
            if(  empty($params['data'])  )
            {
                ...
                $this->setError('Cann\'t get any slider data to generate slide in module  "'. $this->module_name.'".
								<br>Resolve: Please insert data for parameter at tab "Other Settings".
								<br>Good luck!');
            }
        }
        ...
        */
        public function Num2Lang($number, $prefix = 'jhm_')
        {
